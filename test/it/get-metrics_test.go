...
func (g *GetMetricsITSuite) SetupSuite() {
	log.Println("Setting up integration test suite for GetMetricsITSuite")
...
func (g *GetMetricsITSuite) TearDownSuite() {
	...
	log.Println("Tear Down integration test suite for GetMetricsITSuite")
}

func TestGetMetricsITSuite(t *testing.T) {
	suite.Run(t, &GetMetricsITSuite{})
}

func (g *GetMetricsITSuite) TestGetMetrics_Success() {
	...
	g.Contains(string(body), "nginx_up")
}
